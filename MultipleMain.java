...
public class MultipleMain {
	...
	public static void main(String[] args) {
		...
		int games_played = 0;
		final int games_limit = 99;
		double total_time = 0;
		int numberOfWinsForH = 0;
		...
		while(games_played <= games_limit) {
			...
			if(board.finished()) {
				...
				System.out.println(" horizontal ~"+ times[Player.H]/1000000.0 +"ms");
				System.out.println(" vertical   ~"+ times[Player.V]/1000000.0 +"ms");
			} else {
			...
			games_played++;
			total_time += (times[Player.H]+times[Player.V])/1000000.0;
			
			/*just to see it generated slowly*/
			try {
				Thread.sleep(0);
		...
		System.out.println("Total =" + total_time +"ms");
		System.out.println("H wins=" + numberOfWinsForH);
	}
